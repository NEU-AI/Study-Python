...
def show(h,m,s):
	...
	#c=list(s_s)
		if len(s_s)>1:
			...
			#print(s_s)
			#print("time 0 is :",end =" ")
			#print(time[int((s_s)[0])])
			#print("time 1 is :",end =" ")
			#print(time[int((s_s)[1])])
			...
			#else :
			#	result[i]=result[i]+time_s[int((s_s)[0])][i]
			#print ("result i is :",end=" ")
			#print(bin(result[i]))
			#print("time_s 0 is :",end =" ")
			#print(time_s[int((s_s)[0])])
			#print("time_s 1 is :",end =" ")
			#print(time_s[int((s_s)[1])])
		else:
			#print("time is :",end =" ")
			#print(time[int((s_s)[0])])
			#print("int((s_s) :",end =" ")
			...
			#print("time_s is :",end =" ")
			#print(time_s[int((s_s)[0])][i])
		#print("s  result i is : " ,end= " ")
		#print(result[i])
#	for i in range(8):
#		for j in range(8):
#			if time_h[i][j]<2:
#				time_h[i][j]=time_h[i][j]&0
#			if time_m[i][j]<2:
#				time_m[i][j]=time_m[i][j]&0
#			if time_s[i][j]<2:
#				time_s[i][j]=time_s[i][j]&0
...
#			time_s[i][j]=time_s[i][j]&0
	...
	#for i in range(8):
	#	for j in range(8):
	#		result[i]=result[i]+time_h[j][i]+time_m[j][i]+time_s[j][i]
	#for i in range(8):
	#	print(time_h[i])
	for i in range(8):
		print(bin(result[i]))
...
clk_seconds=a[6]
clk=5
#rtc.wakeup(2000,lambda t:music())
i=0
